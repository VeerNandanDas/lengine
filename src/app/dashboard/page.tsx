    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-white border border-[#eaeaea] text-xs font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-50 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {metrics.map((metric) => (
          <div
            key={metric.title}
            className="group bg-white rounded-lg border border-[#eaeaea] p-5 transition-colors hover:border-slate-300"
          >
            {/* Top Row: Icon + Title */}
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-md bg-[#fafafa] border border-[#eaeaea]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {/* Search Volume Chart */}
        <div className="bg-white rounded-lg border border-[#eaeaea] p-6 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-mono text-emerald-600 bg-emerald-50 px-1.5 py-0.2 rounded border border-emerald-200">
                  +18.4%
                </span>
              </div>
            ...
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#fafafa] border border-[#eaeaea]">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-mono text-slate-600 bg-slate-100 px-1.5 py-0.2 rounded border border-[#eaeaea]">
                  5 Global Hubs
                </span>
              </div>
              <p className="text-xs text-slate-500 mt-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link
          href="/dashboard/trade-flows"
          className="group bg-white rounded-lg border border-[#eaeaea] p-5 hover:border-slate-300 transition-all flex items-start justify-between"
        >
          <div className="flex items-start gap-3">
            <div className="h-9 w-9 rounded-md bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 flex-shrink-0 mt-0.5">
          ...
          <ArrowRight className="h-4 w-4 text-slate-400 group-hover:text-slate-900 group-hover:translate-x-0.5 transition-all flex-shrink-0 ml-3" />
        </Link>
        ...
        >
          <div className="flex items-start gap-3">
            <div className="h-9 w-9 rounded-md bg-slate-100 border border-[#eaeaea] flex items-center justify-center text-slate-800 flex-shrink-0 mt-0.5">
      ...
      <div className="bg-white rounded-lg border border-[#eaeaea] p-6">
        ...
        <div className="space-y-3">
          {[
            ...
            <div
              key={i}
              className="flex items-center justify-between py-3 border-b border-[#eaeaea] last:border-0"
            >
