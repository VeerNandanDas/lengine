...
export const ShadcnLogo = ({ className }: { className?: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 26 26"
  ...
  return (
    <div className={cn("relative h-full w-full", className)}>
      ...
      <div className="absolute top-1/2 left-1/2 z-20 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-lg border border-border bg-background p-0.5 shadow-md sm:rounded-2xl sm:p-2 sm:shadow-xl">
        ...
        <motion.div
          className="absolute inset-0 rounded-lg border-2 border-primary/10 sm:rounded-2xl pointer-events-none"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, var(--foreground, #0f172a) 1px, transparent 1px)",
          backgroundSize: "32px 32px",
        }}
      />
      {/* Gradient Overlay */}
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-background/60 from-10% via-transparent to-90% to-background/60" />
...
export const IntegrationCard = ({
  ...
  return (
    <Card
      className={cn(
        "mx-auto flex w-full flex-col max-w-[564px] rounded-2xl overflow-hidden p-0 ring-0 border gap-0 bg-card shadow-sm",
        className,
      )}
    >
      <VisualContainer>{visual ?? <Integration />}</VisualContainer>
