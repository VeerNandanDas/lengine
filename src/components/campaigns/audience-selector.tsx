...
export function AudienceSelector({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white dark:bg-[#121215] p-3.5 rounded-xl border border-[#eaeaea] dark:border-[#27272a] shadow-xs">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full h-9 pl-9 pr-3 rounded-lg border border-[#eaeaea] dark:border-[#27272a] bg-white dark:bg-[#18181b] text-xs text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-hidden focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-1 focus:ring-indigo-500 font-medium"
          />
        </div>
        ...
        <div className="flex items-center gap-3 self-end sm:self-auto">
          ...
          <Button
            ...
            className="h-8 border-[#eaeaea] dark:border-[#27272a] text-xs font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-[#18181b] hover:bg-slate-50 dark:hover:bg-[#222226]"
          >
      ...
      <div className="flex items-center justify-between px-4 py-2.5 rounded-lg bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900/60 text-indigo-950 dark:text-indigo-200 text-xs font-medium">
      ...
      {/* Data Table */}
      <div className="rounded-xl border border-[#eaeaea] dark:border-[#27272a] bg-white dark:bg-[#121215] shadow-xs overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="bg-[#fafafa] dark:bg-[#18181b] border-b border-[#eaeaea] dark:border-[#27272a] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider text-[10px]">
              ...
              {filteredBuyers.map((buyer) => {
                ...
                return (
                  <tr
                    ...
                    className={`hover:bg-slate-50/80 dark:hover:bg-[#18181b]/80 transition-colors cursor-pointer ${
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 text-slate-600 dark:text-slate-300">
                      <div className="flex items-center gap-1 font-medium">
                        <Anchor className="h-3 w-3 text-slate-400 dark:text-slate-500 flex-shrink-0" />
                        <span>{buyer.portOfUnlading}</span>
                        <span className="font-mono text-slate-400 dark:text-slate-500 text-[10px]">({buyer.portCode})</span>
                      </div>
                    ...
                    <td className="py-3.5 px-4 text-right">
                      {isUnlocked ? (
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 text-[11px] font-medium">
                          <CheckCircle2 className="h-3.5 w-3.5 text-emerald-600 dark:text-emerald-400" />
                          <span>{contacts.length} Contacts Ready</span>
                        </div>
                      ) : (
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-100 dark:bg-[#18181b] border border-[#eaeaea] dark:border-[#27272a] text-slate-600 dark:text-slate-400 text-[11px] font-medium">
