  ...
  const activities = [
    {
      ...
      company: "Pacific Textiles LLC",
      event: "Downloaded Q3 PDF Catalog",
      time: "14 mins ago",
      channel: "WhatsApp",
    },
    {
      contact: "Astrid Lindgren",
      company: "Meridian Nordic Distribution AG",
      event: "Replied: Requested FOB Pricing Quote",
      time: "1 hour ago",
      channel: "Email",
    },
    {
      contact: "Thomas Nguyen",
      company: "Trans-Pacific Consumer Brands Inc",
      event: "Opened Day 1 Cold Email (3x reads)",
      time: "2 hours ago",
      channel: "Email",
    },
    {
      contact: "Khalid Al-Rashidi",
      company: "Al-Mansoor Gulf Logistics FZE",
