      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-3 mb-6">
          ...
          <a
            ...
            className="group inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-50 dark:bg-[#18181b] hover:bg-white dark:hover:bg-[#202024] border border-slate-200 dark:border-slate-800 hover:border-indigo-300 dark:hover:border-indigo-700 shadow-2xs text-xs text-slate-600 dark:text-slate-400 transition-all"
          ...
          >
            ...
            <span className="font-mono text-[11px] text-indigo-600 dark:text-indigo-400 flex items-center gap-1 group-hover:underline underline-offset-2">
              www.panoraexports.com
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-[#18181b] border border-[#eaeaea] dark:border-[#27272a] shadow-xs text-xs text-slate-600 dark:text-slate-400">
        ...
        {/* Headline */}
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-slate-900 dark:text-white leading-[1.12]">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            href="/dashboard"
            className="inline-flex items-center justify-center h-11 px-6 bg-slate-900 dark:bg-white hover:bg-slate-800 dark:hover:bg-slate-200 text-white dark:text-slate-900 font-medium text-sm rounded-lg shadow-sm transition-colors"
          >
            Enter Live Terminal
          ...
          <Link
            ...
            className="inline-flex items-center justify-center h-11 px-6 border border-[#eaeaea] dark:border-[#27272a] bg-white dark:bg-[#18181b] hover:bg-slate-50 dark:hover:bg-[#27272a] text-slate-700 dark:text-slate-300 font-medium text-sm rounded-lg transition-colors"
          >
        ...
        <div className="mt-12 pt-6 border-t border-[#eaeaea]/80 dark:border-[#27272a]">
          <p className="text-[11px] uppercase tracking-widest font-mono text-slate-400 dark:text-slate-500 mb-4">
            Ingesting Telemetry From Global Carriers &amp; Customs Registries
          </p>
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs font-semibold text-slate-400 dark:text-slate-500 grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all">
        ...
        <div className="relative mt-12">
          ...
          <div className="relative z-10 bg-[#0B0F19] rounded-t-2xl sm:rounded-t-3xl rounded-b-none border-t border-x border-slate-800/90 border-b-0 shadow-[0_-16px_40px_-8px_rgba(16,185,129,0.22),0_-4px_16px_-2px_rgba(15,23,42,0.14),0_0_0_1px_rgba(255,255,255,0.06)] overflow-hidden text-left mb-0">
